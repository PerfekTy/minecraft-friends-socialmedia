      ...
      <div
        className={
          mobileMenu
            ...
            : "md:flex md:h-screen opacity-0 w-[230px] -translate-x-72 md:translate-x-0 md:opacity-100 justify-center dark:border-none fixed transition-all duration-300 ease-in-out md:fixed dark:bg-navbar bg-navbarLight"
        }
      >
        <MainNavbar mobileMenu={mobileMenu} setMobileMenu={setMobileMenu} timeLeft={timeLeft} />
      </div>
